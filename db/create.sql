...
-- -----------------------------------------------------
-- Table `blesk1`.`Prichod`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blesk1`.`Prichod` ;

CREATE TABLE IF NOT EXISTS `blesk1`.`Prichod` (
  `idPrichod` INT NOT NULL AUTO_INCREMENT,
  `idOsoba` INT NOT NULL,
  `kdy` DATETIME(1) NOT NULL,
  PRIMARY KEY (`idPrichod`),
...
-- Table `blesk1`.`Odchod`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blesk1`.`Odchod` ;

CREATE TABLE IF NOT EXISTS `blesk1`.`Odchod` (
  `idOdchod` INT NOT NULL AUTO_INCREMENT,
  `idOsoba` INT NOT NULL,
  `kdy` DATETIME(1) NOT NULL,
  PRIMARY KEY (`idOdchod`),
  INDEX `fk_Odchod_Osoba1_idx` (`idOsoba` ASC))
ENGINE = MyISAM;


-- -----------------------------------------------------
-- Table `blesk1`.`Hlaseni`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blesk1`.`Hlaseni` ;

CREATE TABLE IF NOT EXISTS `blesk1`.`Hlaseni` (
...
CREATE TABLE IF NOT EXISTS `blesk1`.`Dispecer` (
  ...
  `idOsoba` INT NOT NULL,
  `idStav` INT NULL,
  PRIMARY KEY (`idDispecer`, `idOsoba`),
